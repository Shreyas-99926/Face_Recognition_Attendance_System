...
filename = tk.PhotoImage(file = "D:/Engineering/6th Sem/Python MiniProject/Face Recognition Attendance System/FRAS/410280_website-design-background-png_1920x1080_h.png")
...
message = tk.Label(window, text="Face Recognition Attendance System" ,bg="black"  ,fg="white"  ,width=50  ,height=3,font=('times', 30, 'italic bold underline')) 
